...
import { getInitialDirection, getInitialDirections, getInitialSnakePosition } from "utils/constants";
import { DirectionType, KeyCodeDirection, KeyCodeType, OppositeKeyCodeDirection } from "utils/types";
...
const useGame = () => {
    ...
    const [snakeCoordinates, setSnakeCoordinates] = useState(getInitialSnakePosition());
